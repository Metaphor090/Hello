...
function GetUI()
	...
	mypage1:nextLine()
	mypage1:addLabel({text="日服：游戏引擎更新中。。。",color="65,105,225",size=30})
	mypage1:nextLine()
	
	mypage1:addLabel({text="国服：三周年",color="65,105,225",size=30})
	mypage1:nextLine()
	mypage1:addLabel({text="台服：2019情人节",color="65,105,225",size=30})
	mypage1:nextLine()
