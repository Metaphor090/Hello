...
function GetUI()
	...
	mypage1:nextLine()
	mypage1:addLabel({text="日服：四期泳装",color="65,105,225",size=30})
	mypage1:nextLine()
	
	mypage1:addLabel({text="国服：夏日监狱大逃脱",color="65,105,225",size=30})
	mypage1:nextLine()
	mypage1:addLabel({text="台服：赝作",color="65,105,225",size=30})
	mypage1:nextLine()
