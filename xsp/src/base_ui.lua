...
function GetUI()
	...
	mypage4:nextLine()
	mypage4:addRadioGroup({id="助战礼装选择",list="迦勒底午餐时光,圣夜晚餐,万华镜,达芬奇,宇宙棱镜,二零三零,天堂之孔,虚数魔术,黑杯,社交界之花,春风游步道,第六天魔王,日轮之城,壬生狼,帝都圣杯战争,坂本侦探事务所,研磨锐牙之暗剑,海滨奢华,白色航游,砂糖假期,小小夏日,迦勒底沙滩排球,Kingjokerjack,盛夏一刻,潜入湛蓝,达芬奇lily,迦勒底下午茶时光,夏日阎魔亭,紫之眼,迎宾兔女郎,死之艺术,毒蛇一艺,柔软的慈爱,迦勒底的学者",w=70,h=90,size=20,color="65,105,225",select = "0"})
	mypage4:nextLine()
	--助战礼装是否满破
